...
I didn’t know what aggregation was and it was mentioned a bit in the lecture. So again looking at what that meant. The formation of a number of things into a cluster. So I guess the conclusion that I made was that to view models as a cluster. The more clusters you have the better the picture of the scenario or problem you have. These models used can be a simplified version of reality, but to specify the assumptions and limitations that are present in the model.
I thought that the discussion in the comments about system boundaries is really interesting and seeing that modelling is dependent on how a person thinks and their perception of the problem.  In addition to this, I understood that the use of the model defines the context and boundaries that that system will have. 
For example, a car. You can have the components of metal, motor wheels, but it is their a) purpose and b) the relationship with other major components such as a car frame that identify the system and the system boundary as an object car. 
...
![image](https://user-images.githubusercontent.com/79739278/118799720-6580ed80-b8e2-11eb-97b5-7b1ea86b1712.png)
...
-	Bass model – describes the process of how new ideas get adopted in a population – can be used for marketing as well
...
Other notes to make for this week is that the assignment group had our meeting during stuvac week and another meeting this week. Things are going well. We have delegated tasks and have started working on our sections and getting the submission ready for the draft of the project.
...
2.	I saw on the lecture slide about game theory and didn’t really know what this was. So I looked further into this a think it is quite a compelling subject. It talks about how comparing strategies to determine what will work  to produce a better outcome. It uses interactions between humans as models for other scenarios such as economy and business.
3.	The Colonel Blotto Game - I understand the concept that having more numbers of a troop at time wins the round and that it depends on how many troops you are putting in the one place. However, I think that luck would also play a part in this as well. However, seeing this model in applications is interesting of how effective it can be. Also, I like how this links back to the complexity of people’s behaviour and how unpredictable it can be – deciding the number of troops to put where. 
4.	And within the readings of this week, it was interesting to read about how people are able to cooperate and collectively come together.
...
So, an update on the project is that we have had a couple of group meetings. We have updated the document since submitting it and used the feedback to redirect us. Also, since the marking criteria has changed we also made sure that everyone knew what we were doing. 
I have been working on the stock and flow diagram. Here is a screenshot of the planning of the diagram. 

![image](https://user-images.githubusercontent.com/79739278/118799936-ada01000-b8e2-11eb-8c2e-1333ee5be647.png)
...
This week, I have been working on the documentation of the stock and flow diagram and decided on the ABM model. 


## Week 11:
Again we didn’t have any questions to ask so just continued working on our projects. Also, we have made progress on our project. I have changed the data sources to suit Australia and produced the graphs used for the report. 

![image](https://user-images.githubusercontent.com/79739278/118800013-c7415780-b8e2-11eb-9201-dbaf3c174ad1.png)
